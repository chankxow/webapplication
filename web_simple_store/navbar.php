<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse justify-content-between" id="navbarTogglerDemo03">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">การซื้อและการจัดส่ง</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " href="#">วิธีชำระเงิน</a>
            </li>
            <li class="nav-item">
    ...
    <div class="d-flex justify-content-between " style="width:300px;margin-right:10px;">
